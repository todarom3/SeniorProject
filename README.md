...
Project Overview:  
This project is an end-to-end data analytics platform focused on detecting fraudulent financial transactions.  
The system ingests transaction data, cleans and stores it in a relational database, applies statistical analysis and machine learning techniques to identify fraudulent behavior, and visualizes the results in a dashboard.  
